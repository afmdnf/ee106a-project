...
class PathPlanner(object):
    ...
    def __init__(self, group_name):
        ...
        self._group.set_planner_id("BKPIECEkConfigDefault")
    ...
    def construct_plan(self, position, orientation, constraints=[]):
        ...
        if not plan.multi_dof_joint_trajectory.points and not plan.joint_trajectory.points:
            raise Exception("[ERROR] Plan not found")
        return plan
